...
// Registrando fonte para garantir acentuação correta
Font.register({
  family: 'Helvetica',
  fonts: [
...
const styles = StyleSheet.create({
  ...
  logo: { 
    ...
    borderRadius: 30, 
    marginRight: 15,
    // objectFit: "cover" // Removido pois pode causar problemas em algumas versões
  },
  headerText: { 
    flexDirection: "column" 
  },
  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.header}>
        {/* ✅ CORREÇÃO: Usando a URL completa da sua imagem no Render */}
        <Image 
          style={styles.logo} 
          src="https://personalai-88gw.onrender.com/logo.png" 
        />
